...
def main():
    """Demo of the professional agent with open mic feature."""
    print("=" * 60)
    print("Professional Agent System - Open Mic Demo")
    print("=" * 60)
    ...
    # Try to speak without opening mic (should fail)
    print(f"\n{agent.speak('Testing without open mic')}")
    
    # Open the microphone
    print(f"\n{agent.open_mic()}")
    
    # Now speak through open mic
    print(f"\n{agent.speak('Welcome to our professional service!')}")
    print(f"{agent.speak('How can I assist you today?')}")
    
    # Listen to input
    print(f"\n{agent.listen('I need help with my account')}")
    print(f"{agent.speak('I would be happy to help you with your account.')}")
    ...
    print("=" * 60)
    for idx, msg in enumerate(agent.get_message_history(), 1):
        print(f"{idx}. {msg}")
